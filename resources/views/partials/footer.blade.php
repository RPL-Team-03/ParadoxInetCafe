<footer class="bg-black text-white">
    <div class="mx-auto w-full max-w-screen-xl p-6 lg:py-8">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center lg:space-x-20 text-center lg:text-left space-y-4 lg:space-y-0">
            ...
            <!-- Waktu Operasional -->
            <p class="text-white text-xl font-semibold lg:mx-4">24 HOURS</p>
        ...
        <div class="text-center mt-4">
            <p class="text-gray-400 text-lg font-medium">
                Jl. Nusantara Raya No.26, Beji, Kecamatan Beji, Kota Depok, Jawa Barat 16421
            </p>
        </div>
        ...
        <div class="text-center">
            <span class="text-sm text-gray-400">
                &copy; 2025 Paradox™. All Rights Reserved.
            </span>
        </div>
    </div>
</footer>
